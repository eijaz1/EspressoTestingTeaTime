...
class IdlingResourceMenuActivityTest {
     ...
     */
    @Rule
    var mActivityTestRule = ActivityTestRule<MenuActivity>(MenuActivity::class.java)
    ...
    fun registerIdlingResource() {
        mIdlingResource = mActivityTestRule.activity.idlingResource
